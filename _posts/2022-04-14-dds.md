...
3. *TRANSIENT_DURABILITY_QOS*：在上述基础上，持久化到本地，这样就不会丢数据来；
...
2. *RELIABLE_RELIABILITY_QOS*：保证可靠性；会等待 remote 的到达确认，如果数据丢失会重传；
   ...
   * DataWriter 和 DataReader 的 QOS 需要配对使用，如下：
     ...
     | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------- |
     | [`BEST_EFFORT_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind27BEST_EFFORT_RELIABILITY_QOSE) | [`BEST_EFFORT_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind27BEST_EFFORT_RELIABILITY_QOSE) | Yes           |
     | [`BEST_EFFORT_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind27BEST_EFFORT_RELIABILITY_QOSE) | [`RELIABLE_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind24RELIABLE_RELIABILITY_QOSE) | No            |
     | [`RELIABLE_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind24RELIABLE_RELIABILITY_QOSE) | [`BEST_EFFORT_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind27BEST_EFFORT_RELIABILITY_QOSE) | Yes           |
     | [`RELIABLE_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind24RELIABLE_RELIABILITY_QOSE) | [`RELIABLE_RELIABILITY_QOS`](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/api_reference/dds_pim/core/policy/reliabilityqospolicykind.html#_CPPv4N8eprosima7fastdds3dds24ReliabilityQosPolicyKind24RELIABLE_RELIABILITY_QOSE) | Yes           |

   

#### [HistoryQosPolicy](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/dds_layer/core/policy/standardQosPolicies.html#historyqospolicykind)

> 配置已发送数据的缓存规则；
>
> 该策略行为会受到 *ResourceLimitsQosPolicy* 配置的影响；

1. *KEEP_LAST_HISTORY_QOS*：保留最新*depth*条数据； depth 需满足`depth < ResourceLimitsQosPolicy.max_samples_per_instance`;
...
> 补充知识：
>
> 1. [Topics, keys and instances](https://fast-dds.docs.eprosima.com/en/v2.6.0/fastdds/dds_layer/topic/instances.html#topics-keys-and-instances)，什么是  [DDS Samples, Instances, and Keys](https://community.rti.com/static/documentation/connext-dds/5.2.3/doc/manuals/connext_dds/html_files/RTI_ConnextDDS_CoreLibraries_UsersManual/Content/UsersManual/DDS_Samples__Instances__and_Keys.htm#DDSSamplesInstancesandKeys)
> 2. [Managing Data Instances](https://community.rti.com/static/documentation/connext-dds/5.2.3/doc/manuals/connext_dds/html_files/RTI_ConnextDDS_CoreLibraries_UsersManual/Content/UsersManual/Managing_Data_Instances__Working_with_Ke.htm#sending_2410472787_2040704)
...
3. *announcement_period*：只有 kind 为 上述 1或者3才会生效，表示发送心跳包之间的时间间隔；
