...
5. 服务端配置完毕，现在配置客户端(客户端强烈建议使用 [SS-NG 客户端](<https://github.com/shadowsocks/ShadowsocksX-NG>),配置见[这里](<https://github.com/shadowsocks/ShadowsocksX-NG/issues/926>))

   ```
   下载：https://github.com/xtaci/kcptun/releases/download/v20190321/kcptun-darwin-amd64-20190321.tar.gz
   
   ./client_darwin_amd64 -r "——————IP———————:10087" -l ":1088" -mode fast3 --crypt "none" 
